...
#
    ...
    SR.get_ServiceReportAssetsList('6thReportDate',
                                   ...
                                   ['20190101_funding_abs9_asset_1166_0','20190101_funding_abs9_asset_1166_1','20190101_funding_abs9_asset_1166_2','20190101_funding_abs9_asset_1166_3'], #AllAssetList
                                   #['20190201_funding_abs11_asset_1276_0','20190201_funding_abs11_asset_1276_1'],
                                   #['20190301_funding_abs11_asset_1351_0','20190301_funding_abs11_asset_1351_1'],
                                   '',              #'DefaultAssetList',
                                   '',#'abs9_waived_20181201',              #'WaivedAssetList',20180901_funding_abs9_waived_845
                                   ''#20190101_funding_abs11_unquali_1164'  #'RedemptionAssetList' #20180801_funding_abs9_unquali_784 
                                   ) 
    
    #logger.info('Total default result is {0}'.format(SR.service_report_AllAssetList[SR.service_report_AllAssetList['Days_Overdue_Max']>90]['Amount_Outstanding_yuan'].sum()))
...
#
    ...
    #SR.service_report_AllAssetList = SR.service_report_AllAssetList[SR.service_report_AllAssetList['入池时间'] == '2018/04/16']
...
#    
#    check.to_csv(path_root  + '/../CheckTheseProjects/' +ProjectName + '/compare_OutstandingPrincipal_with_pre.csv',encoding="utf_8_sig")
##
...
#                                                       ]
#    for_report.to_csv(path_root  + '/../CheckTheseProjects/' +ProjectName+'/' + 'for_report_check_fiveclass_assets.csv',encoding="utf_8_sig")
