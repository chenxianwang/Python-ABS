...
DWH_header_rename = {'#合同号':'No_Contract','SKP_CLIENT':'ID','证件号码':'ID',#'SKP_CLIENT':'ID', #SKP_CLIENT 
                     '职业':'Profession','购买商品':'Usage','信用评分':'Credit_Score_15','业务品种':'Type_Loans',
                     '年收入(万元)':'Income','省份':'Province','起始日':'Dt_Start','初始还款日':'Dt_First_Pay','到期日':'Dt_Maturity','合同期限':'Term_Contract',
                      '剩余期数':'Term_Remain','合同本金(元)':'Amount_Contract_yuan',
                      '截至封包日剩余本金(元)':'Amount_Outstanding_yuan',
                      #'合同余额(元)':'Amount_Outstanding_yuan',
...
sr_distribution_rename = {'订单号':'No_Contract','账户号':'ID','借款人职业':'Profession','G4:商品类型':'Usage','贷款用途':'Usage',
                     '信用分数':'Credit_Score',
                     '初始还款日':'Dt_First_Pay','出生日期':'Dt_Birthday',                    
                     '年龄':'Age_Project_Start',
                     '年收入':'Income','G3：省份':'Province','贷款发放日':'Dt_Start','贷款到期日':'Dt_Maturity',
                     '合同期数':'Term_Contract','剩余期数':'Term_Remain', 
                     '借款人年龄':'Age_Project_Start','借款人年收入':'Income','信用评分':'Credit_Score',
                      '合同金额':'Amount_Contract_yuan',
                      '剩余本金':'Amount_Outstanding_yuan','截至封包日剩余本金':'Amount_Outstanding_yuan',
                          ...
                          '合同天数':'LoanTerm','账龄':'LoanAge','剩余天数':'LoanRemainTerm',
                          #'性别':'Gender','家庭状况':'Marriagestate','历史逾期次数':'Overdue_Times',#'综合费用率':'综合费用率',
                          #'SERVICE_FEE_RATE':'SERVICE_FEE_RATE','IS_NEW_SERVICE_FEE_CALCULATION':'SERVICE_FEE_CALCULATION',
                          #'FLEXIBLE_PACKAGE_FLAG':'FLEXIBLE_PACKAGE_FLAG','FLEXIBLE_PACKAGE_NAME':'FLEXIBLE_PACKAGE_NAME'
                          }
