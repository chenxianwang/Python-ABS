...
#    
    RD.get_AssetPool(['Original_part_1','Original_part_2']) #ABS11R3_selected_to_HCCFC_20190306
...
#
    #RD.select_by_ContractNO('exclude',['ABS13_initialpool_all_attris_20190320']) 
...
###    
    ...
    #RD.asset_pool.rename(columns = Header_Rename_REVERSE).to_csv(path_root  + '/../CheckTheseProjects/' +ProjectName+'/to_exclude_from_ABSSystem.csv',index=False,encoding="utf_8_sig")
