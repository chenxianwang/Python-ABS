...
##    
    ...
    #RD.get_AssetPool(['abs11r1_selected_to_Trust_20190103'])
##
...
#    
    ...
    #print(type(RD.asset_pool['first_due_date_after_pool_cut'][0]))#.to_csv(path_project + '/unique_first_due_date_after_pool_cut.csv')
    #print(RD.asset_pool['first_due_date_after_pool_cut'][0])
