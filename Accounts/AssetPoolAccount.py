...
class AssetPoolAccount():
    ...
    def __init__(self,ACF,ACFa):
        ...
        self.recylce_principal_overdue_1_30_currentTerm[dates_recycle[0]] = ACFa['principal_overdue_1_30_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_principal_overdue_1_30_allTerm[dates_recycle[0]] = ACFa['principal_overdue_1_30_allTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_principal_overdue_31_60_currentTerm[dates_recycle[0]] = ACFa['principal_overdue_31_60_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_principal_overdue_31_60_allTerm[dates_recycle[0]] = ACFa['principal_overdue_31_60_allTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_principal_overdue_61_90_currentTerm[dates_recycle[0]] = ACFa['principal_overdue_61_90_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_principal_overdue_61_90_allTerm[dates_recycle[0]] = ACFa['principal_overdue_61_90_allTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        
        self.recylce_principal_loss_currentTerm = {k:ACFa[ACFa['date_recycle'] == k]['principal_loss_currentTerm'].sum() for k in dates_recycle}
        self.recylce_principal_loss_currentTerm[dates_recycle[0]] = ACFa['principal_loss_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_interest_overdue_1_30_currentTerm[dates_recycle[0]] = ACFa['interest_overdue_1_30_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_interest_overdue_1_30_allTerm[dates_recycle[0]] = ACFa['interest_overdue_1_30_allTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_interest_overdue_31_60_currentTerm[dates_recycle[0]] = ACFa['interest_overdue_31_60_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_interest_overdue_31_60_allTerm[dates_recycle[0]] = ACFa['interest_overdue_31_60_allTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_interest_overdue_61_90_currentTerm[dates_recycle[0]] = ACFa['interest_overdue_61_90_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        ...
        self.recylce_interest_overdue_61_90_allTerm[dates_recycle[0]] = ACFa['interest_overdue_61_90_allTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
        
        self.recylce_interest_loss_currentTerm = {k:ACFa[ACFa['date_recycle'] == k]['interest_loss_currentTerm'].sum() for k in dates_recycle}
        self.recylce_interest_loss_currentTerm[dates_recycle[0]] = ACFa['interest_loss_currentTerm'][ACFa['date_recycle'] <= dates_recycle[0]].sum()
